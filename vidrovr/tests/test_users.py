...
class TestUsers(BaseTest):
    ...
    def test_token_create(self):
        ...
        assert result.id is not None, "An ID value for the token should have been returned."

    def test_token_read(self):
        result = Token.read(self.user_id)

        assert result is not None, "A list of valid TokenData objects should have been returned."
