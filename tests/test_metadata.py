...
class TestMetadata(BaseTest):
    def test_custom_tags_read(self):
        ...
        assert (
            result is not None
        ), "A list of CustomTagData objects should have been returned."
    ...
    def test_custom_tags_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid CustomTagData object should have been returned."
    ...
    def test_generic_tags_read(self):
        ...
        assert (
            result is not None
        ), "A list of GenericTagData objects should have been returned."
    ...
    def test_generic_tags_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid GenericTagData object should have been returned."
        assert result.id is not None, "An ID value should have been returned."
    ...
    def test_iab_tags_read(self):
        ...
        assert (
            result is not None
        ), "A list of IABTagData objects should have been returned,"
    ...
    def test_iab_tags_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid IABTagData object should have been returned."
        assert result.id is not None, "An ID value should have been returned."
    ...
    def test_keyphrases_read(self):
        ...
        assert (
            result is not None
        ), "A list of KeyphraseData objects should have been returned."
    ...
    def test_named_entities_read(self):
        ...
        assert (
            result is not None
        ), "A list of NamedEntityData objects should have been returned."
    ...
    def test_named_entities_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid NamedEntityObject should have been returned."
        assert result.id is not None, "An ID value should have been returned."
    ...
    def test_object_read(self):
        ...
        assert (
            result is not None
        ), "A list of ObjectData objects should have been returned."
    ...
    def test_object_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid ObjectData object should have been returned."
        assert result.id is not None, "An ID value should have been returned."
    ...
    def test_ocr_read(self):
        ...
        assert (
            result is not None
        ), "A list of OCRData objects should have been returned."
    ...
    def test_person_read(self):
        ...
        assert (
            result is not None
        ), "A list of PersonData objects should have been returned."
    ...
    def test_person_detail_read(self):
        ...
        assert (
            result is not None
        ), "A valid PersonData object should have been returned."
        assert result.id is not None, "An ID value should have been returned."
    ...
    def test_transcript_read(self):
        ...
        assert (
            result is not None
        ), "A valid TranscriptData object should have been returned."
